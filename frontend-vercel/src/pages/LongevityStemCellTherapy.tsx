...
import { ChevronLeft, Stethoscope, Wallet, CheckCircle2, Sparkles } from "lucide-react";
import { Link } from "react-router-dom";
import TopBanner from "@/components/TopBanner";
import Header from "@/components/Header";
import Footer from "@/components/Footer";
import heroImage from "@/img/longevity-stem-cell-therapy.png";
...
const COPY = {
  ...
  heroTitle: "Longevity Stem Cell Therapy",
  heroSubtitle: "Anti-Aging & Regenerative Wellness",
  heroDesc:
    "Longevity stem cell therapy uses regenerative cell infusions to slow biological aging, restore organ vitality, boost immune function, and improve overall health. China offers comprehensive wellness-focused programs at licensed medical centers.",
  whatIsItTitle: "What Is It?",
  typesTitle: "Cell Types Used",
  ...
  ctaSubtitle: "Get Your Personalized Longevity Stem Cell Therapy Plan and Quote",
...
const cellTypes = [
  {
    ...
    desc: "From umbilical cord Wharton's jelly; powerful anti-inflammatory.",
    tag: "Anti-inflammatory",
  },
  {
    name: "Exosomes",
    desc: "Nano-sized vesicles delivering growth factors and microRNA systemically.",
    tag: "Delivery",
  },
  {
    name: "NK (Natural Killer) Cell Therapy",
    desc: "Immune enhancement; combined with stem cells.",
    tag: "Immune",
  },
  {
    name: "Platelet-Rich Plasma (PRP)",
    desc: "Autologous growth factors; skin and joint rejuvenation.",
    tag: "Rejuvenation",
  },
];

const protocolSteps = [
  { label: "Testing", value: "Comprehensive biomarker testing: telomere length, inflammation markers, hormones, organ function" },
  { label: "Plan", value: "Personalized infusion plan: IV drip over 2–4 hours per session" },
  { label: "Course", value: "3–6 infusions over 5–10 days" },
];

const benefits = [
  "Improved energy, sleep quality, and mental clarity",
  "Enhanced skin texture",
  "Stronger immune response",
  "Improved hormonal balance and vitality",
];

const pricing = [
  { procedure: "Single Exosome Infusion Session", price: "$2,800 – $5,500" },
  { procedure: "Standard MSC Program (3 sessions)", price: "$11,100 – $20,800" },
  { procedure: "Premium Longevity Package (5–6 sessions)", price: "$20,800 – $38,900" },
  { procedure: "Elite Package (stem cells + NK cells + exosomes)", price: "$34,700 – $69,400" },
];
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-10 sm:py-14">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg">
                <img
                  src={heroImage}
                  alt="Longevity Stem Cell Therapy"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm">
              ...
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                Longevity stem cell therapy uses regenerative cell infusions to slow biological aging,
                restore organ vitality, boost immune function, and improve overall health. China offers
                comprehensive wellness-focused programs at licensed medical centers.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="bg-[#1DA78A]/5 rounded-2xl p-6 sm:p-8 border border-[#1DA78A]/10">
              <div className="flex items-center gap-2 mb-5">
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-[#1A2433]">{COPY.benefitsTitle}</h2>
              </div>
