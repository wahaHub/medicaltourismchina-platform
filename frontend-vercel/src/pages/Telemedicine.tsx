...
const ARABIC_EXPERT_COPY = [
  {
    title: "استشاري أول",
    specialty: "الأورام الطبية",
    hospital: "شبكة مستشفيات تخصصية في شنغهاي",
    credentials: ["أكثر من 23 عاماً من الخبرة السريرية", "مراجعة حالات الأورام المعقدة", "طبيب في مستشفى تخصصي"],
    tags: ["مراجعة مكتوبة", "استشارة فيديو", "دعم باللغة الإنجليزية"],
    bio: "متخصص في مراجعة حالات سرطان الرئة والجهاز الهضمي والحالات المعقدة ومناقشة مسارات العلاج العملية.",
    imageAlt: "استشاري أورام صيني يراجع السجلات الطبية",
  },
  {
    title: "طبيب استشاري",
    specialty: "أمراض القلب",
    hospital: "مركز تخصصي في بكين",
    credentials: ["أكثر من 35 عاماً من الخبرة السريرية", "طبيب متخصص معترف به", "طبيب في مستشفى تخصصي"],
    tags: ["مراجعة مكتوبة", "استشارة فيديو", "دعم باللغة الإنجليزية"],
    bio: "خبرة في أمراض الشرايين التاجية وفشل القلب والتشخيصات القلبية المعقدة ووضع خطط المتابعة طويلة الأمد.",
    imageAlt: "طبيب قلب صيني في جلسة استشارة حديثة",
  },
  {
    title: "استشاري أول",
    specialty: "جراحة الأعصاب",
    hospital: "شبكة مستشفيات جامعية في تشنغدو",
    credentials: ["أكثر من 28 عاماً من الخبرة السريرية", "مراجعة الجراحات المعقدة", "طبيب في مستشفى تخصصي"],
    tags: ["مراجعة مكتوبة", "استشارة فيديو", "دعم باللغة الإنجليزية"],
    bio: "يقدم مراجعات للرأي الثاني بشأن أورام الدماغ وأمراض العمود الفقري وقرارات جراحة الأعصاب الوظيفية.",
    imageAlt: "صورة لطبيب جراحة أعصاب صيني في مستشفى",
  },
];

const ARABIC_PLAN_COPY = [
  {
    badge: "أساسي",
    title: "مراجعة مكتوبة",
    chips: ["تقرير مكتوب", "مراجعة السجلات", "48–72 ساعة"],
    cta: "احجز",
    detailsCta: "عرض التفاصيل",
    modal: {
      title: "مراجعة مكتوبة من طبيب متخصص",
      body: "يراجع طبيب متخصص سجلاتك الطبية ويقدم رأياً طبياً ثانياً مكتوباً يساعدك على فهم التشخيص وخطة العلاج والخطوات التالية.",
      bestForLabel: "مناسبة لـ",
      bestFor: "المرضى الذين لديهم تقارير طبية ويريدون رأي خبير إضافياً قبل اتخاذ قرار علاجي.",
      receiveLabel: "ما الذي ستحصل عليه",
      receive: ["ملخص التشخيص والحالة", "أهم النتائج في السجلات", "ملاحظات الطبيب", "اعتبارات العلاج", "أسئلة مقترحة لطبيبك المحلي", "الخطوات التالية المقترحة"],
      processLabel: "الخطوات المعتادة",
      process: ["رفع السجلات الطبية", "تنظيم ملخص الحالة", "مراجعة الطبيب للحالة", "استلام تقرير الرأي الطبي الثاني"],
      turnaroundLabel: "المدة المتوقعة",
      turnaround: "عادةً خلال 48–72 ساعة بعد استلام السجلات كاملة.",
      cta: "ابدأ المراجعة المكتوبة",
      imageAlt: "طبيب صيني يراجع تقارير وصوراً طبية",
    },
  },
  {
    badge: "الأكثر طلباً",
    title: "استشارة فيديو",
    chips: ["مكالمة فيديو", "ملخص مكتوب", "أسئلة وأجوبة"],
    cta: "احجز",
    detailsCta: "عرض التفاصيل",
    modal: {
      title: "استشارة فيديو مع ملخص مكتوب",
      body: "تحدث مع طبيب متخصص عبر الفيديو بدعم من منسق Medora الطبي، واحصل على ملخص مكتوب بعد الاستشارة.",
      bestForLabel: "مناسبة لـ",
      bestFor: "المرضى الذين يريدون طرح أسئلتهم مباشرة وفهم خيارات العلاج ومعاني نتائجهم الطبية.",
      receiveLabel: "ما الذي ستحصل عليه",
      receive: ["مراجعة السجلات قبل الاتصال", "استشارة فيديو لمدة 20–30 دقيقة", "تجهيز الأسئلة مسبقاً", "ملاحظات الطبيب الرئيسية", "ملخص مكتوب للاستشارة", "الخطوات التالية"],
      processLabel: "الخطوات المعتادة",
      process: ["رفع السجلات", "إعداد ملخص الحالة", "تحديد موعد الاستشارة", "التحدث مع الطبيب عبر الفيديو", "استلام ملخص المتابعة"],
      turnaroundLabel: "المدة المتوقعة",
      turnaround: "عادةً يُحدد الموعد خلال 3–5 أيام عمل بعد استلام السجلات كاملة.",
      cta: "احجز استشارة فيديو",
      imageAlt: "مريض دولي يتحدث مع طبيب صيني عبر الفيديو",
    },
  },
  {
    badge: "مراجعة متقدمة",
    title: "مراجعة متعددة التخصصات",
    chips: ["عدة أطباء متخصصين", "حالات معقدة", "ملخص متقدم"],
    cta: "اطلب",
    detailsCta: "عرض التفاصيل",
    modal: {
      title: "مراجعة حالة متعددة التخصصات",
      body: "للحالات الطبية المعقدة، تنسق Medora مراجعة أعمق بمشاركة عدة أطباء متخصصين عند الحاجة.",
      bestForLabel: "مناسبة لـ",
      bestFor: "حالات السرطان المعقدة والجراحات الكبرى وأمراض الأعصاب وقرارات القلب أو عند تعارض توصيات العلاج.",
      receiveLabel: "ما الذي ستحصل عليه",
      receive: ["تقييم شامل للحالة", "مراجعة السجلات والصور والأنسجة", "مناقشة بين عدة تخصصات", "ملخص متقدم للرأي الطبي الثاني", "اعتبارات مسار العلاج", "توصيات للخطوات التالية"],
      processLabel: "الخطوات المعتادة",
      process: ["إرسال السجلات كاملة", "إعداد ملف منظم للحالة", "مراجعة الأطباء المعنيين", "إعداد ملخص متعدد التخصصات", "مناقشة الخطوات الممكنة معك"],
      turnaroundLabel: "المدة المتوقعة",
      turnaround: "عادةً خلال 5–7 أيام عمل بعد استلام السجلات كاملة.",
      cta: "اطلب المراجعة المتقدمة",
      imageAlt: "اجتماع أطباء متعدد التخصصات لمراجعة حالة طبية",
    },
  },
];

TELEMEDICINE_COPY.ar = {
  ...TELEMEDICINE_COPY.en,
  metaTitle: "استشارة عن بُعد مع أطباء متخصصين في الصين | Medora Health",
  hero: {
    label: "استشارة عن بُعد مع أطباء متخصصين في الصين",
    title: "هل لديك أسئلة حول التشخيص أو خطة العلاج؟",
    subtitle: "احصل على مراجعة مكتوبة أو استشارة فيديو أو رأي طبي ثانٍ متعدد التخصصات من أطباء متخصصين في الصين.",
    support: "ارفع سجلاتك الطبية واحصل على توجيه متخصص قبل اتخاذ قرارك الطبي التالي.",
    primaryCta: "احجز استشارة عن بُعد",
    imageAlt: "طبيب صيني يراجع سجلات طبية لاستشارة عن بُعد",
  },
  trust: [
    ["أطباء صينيون متخصصون", "نطابق حالتك مع الطبيب الأنسب لتخصصك."],
    ["السجلات الطبية أولاً", "نبدأ بالتقارير والصور والأنسجة والتحاليل والتاريخ الطبي."],
    ["تنسيق متعدد اللغات", "ننظم ملفك ونترجم المعلومات الأساسية ونلخص الحالة."],
    ["السفر اختياري", "ابدأ عن بُعد، وفكّر في السفر فقط إذا كان مناسباً لحالتك."],
  ],
  expertShowcase: {
    ...TELEMEDICINE_COPY.en.expertShowcase,
    label: "مطابقة الطبيب",
    title: "أطباء صينيون متخصصون مختارون",
    body: "تطابق Medora حالتك مع طبيب متخصص يمكنه تقديم مراجعة مكتوبة أو استشارة فيديو ومناقشة اتجاه العلاج.",
    tabs: ["الأورام", "أمراض القلب", "الأعصاب", "العظام", "الطب التناسلي"],
    moreTabs: ["الجراحة التجميلية", "الخلايا الجذعية", "طب الأسنان", "طب الأطفال", "المسالك البولية", "الغدد الصماء", "طب العيون"],
    moreLabel: "المزيد",
    collapseLabel: "عرض أقل",
    expertCta: "عرض الطبيب",
    matchPrompt: "أخبرنا عن حالتك وسنقترح الطبيب الأكثر ملاءمة.",
    matchCta: "احصل على اقتراح لطبيب متخصص",
    customTitle: "هل تحتاج إلى تخصص مختلف؟",
    customBody: "شارك التشخيص والسجلات والتخصص المطلوب وهدف الاستشارة، وسنقترح طبيباً أو فريقاً مناسباً.",
    customCta: "أخبرنا بما تحتاجه",
    featuredLabel: "اختيار مميز",
    experts: TELEMEDICINE_COPY.en.expertShowcase.experts.map((expert, index) => ({
      ...expert,
      ...(ARABIC_EXPERT_COPY[index] ?? {}),
    })),
  },
  review: {
    label: "خيارات المراجعة",
    title: "اختر نوع الرأي الطبي الثاني",
    body: "ابدأ عن بُعد بمراجعة مكتوبة أو استشارة فيديو أو مراجعة متعددة التخصصات قبل قرارك الطبي التالي.",
    plans: TELEMEDICINE_COPY.en.review.plans.map((plan, index) => ({
      ...plan,
      ...(ARABIC_PLAN_COPY[index] ?? {}),
      modal: {
        ...plan.modal,
        ...(ARABIC_PLAN_COPY[index]?.modal ?? {}),
      },
    })),
  },
  comparison: {
    label: "مقارنة مباشرة",
    title: "قارن خيارات المراجعة",
    cta: "قارن خيارات المراجعة",
    headers: ["الميزة", "مراجعة مكتوبة", "استشارة فيديو", "مراجعة متعددة التخصصات"],
    a11yDescription: "جدول يقارن خيارات الاستشارة الطبية عن بُعد.",
    rows: [
      ["استلام السجلات الطبية", "نعم", "نعم", "نعم"],
      ["إعداد ملخص الحالة", "نعم", "نعم", "نعم"],
      ["رأي مكتوب من الطبيب", "نعم", "نعم", "نعم"],
      ["مناقشة عبر الفيديو", "لا", "نعم", "اختيارية أو ضمن الباقة"],
      ["دعم المنسق الطبي", "نعم", "نعم", "نعم"],
      ["مراجعة مركزة على الأورام", "محدودة", "متاحة", "شاملة"],
      ["مشاركة عدة أطباء", "لا", "أحياناً", "نعم"],
      ["مناقشة مسار العلاج", "أساسية", "مفصلة", "متقدمة"],
      ["مطابقة مستشفى في الصين", "اختيارية", "اختيارية", "متاحة إذا كانت مناسبة"],
      ["الأنسب لـ", "رأي طبي عام", "مرضى لديهم أسئلة", "الحالات المعقدة"],
      ["المدة المعتادة", "48–72 ساعة", "3–5 أيام عمل", "5–7 أيام عمل"],
    ],
  },
  process: {
    label: "الخطوات",
    title: "كيف تحصل على الرأي الطبي الثاني؟",
    stepLabel: "الخطوة",
    steps: [
      ["أرسل سجلاتك الطبية", "ارفع تقارير التشخيص والصور والأنسجة والتحاليل وخطط العلاج وقائمة الأدوية."],
      ["تنظيم الحالة والملخص الطبي", "ينظم فريق Medora المستندات ويترجم المعلومات الأساسية عند الحاجة ويعد ملخصاً واضحاً."],
      ["مراجعة الطبيب أو الاستشارة", "يراجع الطبيب حالتك أو يناقشها معك عبر الفيديو أو ضمن فريق متعدد التخصصات."],
      ["استلم الرأي الطبي الثاني", "تحصل على ملخص مكتوب بالملاحظات الرئيسية واعتبارات العلاج والخطوات المقترحة."],
      ["استكشف العلاج في الصين إذا كان مناسباً", "يمكننا المساعدة في اختيار المستشفى وتقدير التكلفة والمواعيد وترتيبات السفر."],
    ],
  },
  specialists: {
    label: "شبكة التخصصات",
    title: "مراجعة من أطباء صينيين متخصصين",
    body: "تنسق Medora المراجعة وفق حالتك وسجلاتك الطبية ونوع الاستشارة المختار.",
    items: [
      ["الأورام", "تشخيص السرطان وتسلسل العلاج والعلاج الكيميائي والمناعي والموجه والجراحة."],
      ["الجراحة", "قرارات الجراحات الكبرى والرأي الثاني قبل العملية والمخاطر والتعافي."],
      ["العظام", "المفاصل والعمود الفقري والإصابات الرياضية وإعادة التأهيل."],
      ["أمراض القلب", "أمراض القلب والتدخلات والجراحة وخطط المتابعة طويلة الأمد."],
      ["الأعصاب وجراحة الأعصاب", "أمراض الدماغ والعمود الفقري والأعصاب والقرارات العلاجية المعقدة."],
      ["الجراحة التجميلية والترميمية", "تخطيط الإجراء وتقييم الملاءمة ومناقشة النتائج المتوقعة."],
    ],
  },
  notice: {
    label: "تنبيه طبي",
    title: "تنبيه طبي مهم",
    body: "تعتمد خدمة الرأي الطبي الثاني على السجلات التي تقدمها. ليست خدمة طوارئ ولا تستبدل طبيبك المحلي، ويجب اتخاذ قرارات العلاج مع مقدم رعاية صحية مرخص.",
    items: [
      ["ليست رعاية طارئة", "عند وجود أعراض عاجلة أو حالة طارئة، اتصل بخدمات الطوارئ المحلية فوراً."],
      ["مراجعة تعتمد على السجلات", "تعتمد جودة المراجعة على اكتمال ودقة المستندات المقدمة."],
      ["ناقشها مع طبيبك المحلي", "استخدم الرأي الثاني كوجهة نظر إضافية تناقشها مع طبيبك المعالج."],
    ],
  },
  faq: {
    ...
    title: "أسئلة شائعة",
    items: [
      ["هل هذه خدمة تشخيص عبر الإنترنت؟", "لا. إنها مراجعة للسجلات الطبية ورأي طبي ثانٍ بناءً على المعلومات التي تقدمها."],
      ["أي خيار أختار؟", "اختر المراجعة المكتوبة لتقرير، أو الفيديو للتحدث مباشرة، أو المراجعة متعددة التخصصات للحالات المعقدة."],
      ["هل يمكن البدء بمراجعة مكتوبة ثم الترقية؟", "نعم. يبدأ كثير من المرضى بمراجعة مكتوبة ثم يطلبون استشارة فيديو أو مراجعة إضافية."],
      ["ما السجلات المطلوبة؟", "تقارير التشخيص والصور والأنسجة والتحاليل وملخصات الخروج وتاريخ العلاج والأدوية والخطة الحالية."],
      ["كم تستغرق الخدمة؟", "المراجعة المكتوبة عادةً 48–72 ساعة، والفيديو 3–5 أيام عمل، والحالات المعقدة 5–7 أيام عمل."],
      ["هل يجب أن أسافر إلى الصين؟", "لا. يبدأ الرأي الثاني عن بُعد، ويمكننا مساعدتك في استكشاف العلاج في الصين إذا كان مناسباً."],
    ],
  },
  finalCta: {
    label: "ابدأ عن بُعد",
    title: "احصل على رأي خبير إضافي قبل قرارك الطبي التالي",
    body: "اختر مراجعة مكتوبة أو استشارة فيديو أو مراجعة حالة متعددة التخصصات.",
    cta: "احجز استشارة عن بُعد",
    note: "ابدأ عن بُعد، دون التزام بالسفر.",
  },
};
