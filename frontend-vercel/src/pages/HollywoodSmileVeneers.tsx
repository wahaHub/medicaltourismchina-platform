...
import heroImage from "@/img/hollywood-smile-veneers.png";
...
const COPY = {
  ...
  heroTitle: "Hollywood Smile Veneers",
  heroSubtitle: "Cosmetic Dentistry — Smile Transformation",
  heroDesc:
    "Hollywood Smile refers to a full smile makeover using dental veneers — ultra-thin shells bonded to the front of teeth to create a perfect, white, symmetrical smile. Widely sought for instant aesthetic transformation.",
  ...
  ctaSubtitle: "Get Your Personalized Hollywood Smile Plan and Quote",
...
const veneerTypes = [
  {
    ...
    desc: "Most natural-looking; durable 10–20 years; stain-resistant; minimal enamel removal.",
    tag: "Popular",
  },
  {
    name: "Composite Resin Veneers",
    desc: "Direct application; lower cost; repairable; lifespan 5–7 years.",
    tag: "Affordable",
  },
  {
    name: "Lumineers",
    desc: "Ultra-thin porcelain; no-prep or minimal-prep; reversible; preserves enamel.",
    tag: "No-prep",
  },
  {
    name: "Zirconia Veneers",
    desc: "Maximum strength; ideal for bruxism patients; opaque white.",
    tag: "Strong",
  },
  {
    name: "E-max (Lithium Disilicate)",
    desc: "Premium translucency; highly aesthetic; very popular.",
    tag: "Premium",
  },
];

const procedureSteps = [
  { label: "Step 1", value: "Consultation + digital smile design (DSD)" },
  { label: "Step 2", value: "Light enamel shaping (0.3–0.7mm)" },
  { label: "Step 3", value: "Temporary veneers placed; permanent veneers bonded at 2nd visit" },
  { label: "Total visits", value: "2–3 visits" },
];

const pricing = [
  { procedure: "Composite Resin Veneers", price: "$110 – $280 / tooth" },
  { procedure: "Domestic Porcelain Veneers", price: "$280 – $550 / tooth" },
  { procedure: "E-max (Imported) Veneers", price: "$490 – $970 / tooth" },
  { procedure: "Lumineers", price: "$550 – $1,100 / tooth" },
  { procedure: "Full Hollywood Smile (16–20 teeth)", price: "$5,500 – $16,700" },
];
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-10 sm:py-14">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg">
                <img
                  src={heroImage}
                  alt="Hollywood Smile Veneers Before & After"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm">
              ...
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                Hollywood Smile refers to a full smile makeover using dental veneers — ultra-thin
                shells bonded to the front of teeth to create a perfect, white, symmetrical smile.
                Widely sought for instant aesthetic transformation.
              </p>
            </div>
          </div>
        </section>
