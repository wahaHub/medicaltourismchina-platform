...
import { ChevronLeft, Stethoscope, Wallet, CheckCircle2, FlaskConical } from "lucide-react";
import { Link } from "react-router-dom";
import TopBanner from "@/components/TopBanner";
import Header from "@/components/Header";
import Footer from "@/components/Footer";
import heroImage from "@/img/diabetes-stem-cell-therapy.png";
...
const COPY = {
  ...
  heroTitle: "Diabetes Stem Cell Therapy",
  heroSubtitle: "Regenerative Medicine — Type 1 & Type 2 Diabetes",
  heroDesc:
    "Stem cell therapy for diabetes aims to regenerate damaged pancreatic beta cells, reduce inflammation, and improve metabolic function. China is a leading destination offering this treatment at specialized licensed centers.",
  whatIsItTitle: "What Is It?",
  typesTitle: "Types of Stem Cells Used",
  ...
  ctaSubtitle: "Get Your Personalized Stem Cell Therapy Plan and Quote",
...
const stemCellTypes = [
  {
    ...
    desc: "Most common; from bone marrow, umbilical cord, or adipose tissue.",
    tag: "Common",
  },
  {
    name: "Umbilical Cord Blood Stem Cells",
    desc: "Rich in growth factors; low rejection risk; widely available in China.",
    tag: "Rich",
  },
  {
    name: "Autologous Bone Marrow Stem Cells",
    desc: "Patient's own cells; no rejection risk.",
    tag: "Autologous",
  },
];

const protocolSteps = [
  { label: "Pre-treatment", value: "HbA1c, C-peptide, organ function evaluation" },
  { label: "Infusion", value: "IV or targeted pancreatic delivery; typical course: 2–4 infusions over 1–2 weeks" },
  { label: "Follow-up", value: "Labs and telemedicine at 1, 3, and 6 months" },
];

const benefits = [
  "Reduced insulin dependency (Type 1) or improved insulin sensitivity (Type 2)",
  "Stabilized blood glucose levels",
  "Reduced HbA1c over 3–6 months",
];

const pricing = [
  { procedure: "Basic MSC Therapy (2 infusions)", price: "$11,000 – $16,700" },
  { procedure: "Standard Protocol (3–4 infusions)", price: "$16,700 – $27,800" },
  { procedure: "Umbilical Cord Stem Cell Program", price: "$13,900 – $25,000" },
  { procedure: "Comprehensive Package (incl. hospitalization)", price: "$25,000 – $41,700" },
];
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center py-10 sm:py-14">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-lg">
                <img
                  src={heroImage}
                  alt="Diabetes Stem Cell Therapy"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
            <div className="bg-white rounded-2xl p-6 sm:p-8 shadow-sm">
              ...
              <p className="text-sm md:text-base text-gray-600 leading-relaxed">
                Stem cell therapy for diabetes aims to regenerate damaged pancreatic beta cells,
                reduce inflammation, and improve metabolic function. China is a leading destination
                offering this treatment at specialized licensed centers.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-12 sm:py-16">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            <div className="flex items-center justify-center gap-2 mb-8">
              <FlaskConical className="h-5 w-5 text-[#1DA78A]" />
