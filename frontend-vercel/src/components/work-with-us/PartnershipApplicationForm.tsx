  ...
  const localeText = locale === "zh"
    ...
    : locale === "ar"
      ? {
          ...
          sectionLabel: "نموذج طلب الشراكة",
          contactHint: "سيُرسل الطلب إلى فريق الشراكات، وسنرسل تأكيداً إلى مقدم الطلب.",
        }
      : locale === "id"
        ? {
            required: "Kolom ini wajib diisi",
            invalidEmail: "Masukkan alamat email yang valid",
            sectionLabel: "Formulir kemitraan",
            contactHint: "Pengajuan akan dikirim ke tim kemitraan dan konfirmasi akan dikirim kepada pemohon.",
          }
        : {
      ...
      <form onSubmit={handleSubmit} className="mt-8">
        ...
        <div className="mt-8 flex flex-col gap-3 border-t border-slate-200 pt-6 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm leading-7 text-slate-500">
            {locale === "zh" ? "提交即表示您同意我们使用以上信息进行合作评估和后续联系。" : locale === "ar" ? "بإرسال الطلب، توافق على مراجعة Medora Health للمعلومات بهدف تقييم الشراكة والمتابعة." : locale === "id" ? "Dengan mengirimkan formulir, Anda menyetujui Medora Health meninjau informasi ini untuk evaluasi kemitraan dan tindak lanjut." : "By submitting, you agree that Medora Health may review this information for partnership evaluation and follow-up."}
          </p>
          <button
            type="submit"
