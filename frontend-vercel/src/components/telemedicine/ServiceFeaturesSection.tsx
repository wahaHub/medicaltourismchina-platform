...
export default function ServiceFeaturesSection() {
  ...
  const features = [
    {
      title: t('telemedicine.features.section1.title'),
      items: [
        t('telemedicine.features.section1.item1'),
        t('telemedicine.features.section1.item2')
      ],
    },
    {
      title: t('telemedicine.features.section2.title'),
      items: [
        t('telemedicine.features.section2.item1'),
        t('telemedicine.features.section2.item2'),
      ],
    },
  ];
          ...
          {features.map((feature, index) => (
            ...
            >
              <IconFeatureCard
                ...
                titleSize="text-lg mt-36 sm:text-xl"
