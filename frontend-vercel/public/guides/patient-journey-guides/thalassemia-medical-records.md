...
Include all pages describing the method, coverage, variant names, interpretation, specimen, and laboratory. A common-variant panel, deletion analysis, and broader sequencing answer different questions. The meaning of a negative result depends on what was examined. If the available paper only says alpha-thalassemia positive, ask the original laboratory whether a more detailed report can be obtained. [ARUP Consult: Thalassemias, updated April 2026](https://arupconsult.com/content/thalassemias)[GeneReviews: Alpha-Thalassemia, current review](https://www.ncbi.nlm.nih.gov/books/NBK1435/)

For beta-thalassemia, retain the exact findings and their interpretation, including relevant combinations with other hemoglobin variants. Label relatives' results with their relationship to the patient. A partner's or parent's report must not appear as the patient's own result. A variant of uncertain significance should remain uncertain in translation, and its clinical interpretation should stay with the qualified team. [Langer: Beta-Thalassemia, GeneReviews, revision February 12, 2026](https://www.ncbi.nlm.nih.gov/books/NBK1426/)
...
Alongside the operation name and date, retain the discharge summary, pathology when relevant, complications, and infection-prevention instructions. Vaccination records should identify vaccine names, dates, and doses rather than simply saying complete. For previous thrombosis, bring the diagnostic imaging and the dated anticoagulation history, including the documented reason for stopping if available. [Amid and Merkeley: Splenomegaly and Splenectomy, TIF alpha guideline 2023](https://www.ncbi.nlm.nih.gov/books/NBK602232/)[TIF 2023: Hypercoagulability and Thrombotic Disease in NTDT](https://www.ncbi.nlm.nih.gov/books/NBK599484/)
