...
- “Possible MDS” is different from an integrated diagnosis supported by the clinical history and laboratory findings. Blood and marrow investigations help the team determine what is happening; the [NHS explanation of MDS investigations](https://www.nhs.uk/conditions/myelodysplastic-syndrome-mds/tests-and-next-steps/) describes the investigation and risk discussion patients can expect.
- Clinical trial eligibility depends on the protocol, including the diagnosis, prior treatment and health requirements. The [NCI guide to eligibility](https://www.cancer.gov/research/participate/clinical-trials/how-trials-work) explains why having the relevant disease does not by itself establish that someone can join. A registry entry is a starting point for checking the study and contacting the research team.
...
Allogeneic hematopoietic stem cell transplantation can offer selected patients a possibility of prolonged disease control or cure, with substantial treatment risks. The [NCI introduction to stem cell transplantation](https://www.cancer.gov/about-cancer/treatment/types/stem-cell-transplant) explains the procedure and complications. A transplant assessment considers the disease alongside organ function, physical condition, donor options and the patient's goals.
...
The [NCI professional MDS treatment summary](https://www.cancer.gov/types/myeloproliferative/hp/myelodysplastic-treatment-pdq) provides an overview of supportive care, disease-modifying treatment and transplantation. These approaches have different purposes. A referral should explain the problem that the proposed medicine is meant to address and how its benefit will be assessed.
...
The [CDC advice for travelers with chronic illnesses](https://www.cdc.gov/yellow-book/hcp/travelers-with-additional-considerations/travelers-with-chronic-illnesses.html) discusses medical preparation. People receiving immunosuppressive treatment or recovering from transplantation also need an individualized discussion informed by the [CDC guidance for immunocompromised travelers](https://www.cdc.gov/yellow-book/hcp/travelers-with-additional-considerations/immunocompromised-travelers.html). A visa and an airline reservation are administrative arrangements, not medical clearance.
...
- NHS, MDS investigations and next steps: https://www.nhs.uk/conditions/myelodysplastic-syndrome-mds/tests-and-next-steps/
- Bernard and colleagues, original IPSS-M study: https://doi.org/10.1056/EVIDoa2200008
- NCI, stem cell transplantation: https://www.cancer.gov/about-cancer/treatment/types/stem-cell-transplant
- NMDP, preparing for transplantation: https://www.nmdp.org/en/patients/transplant-support/preparing-for-transplant
- NCI, professional MDS treatment summary: https://www.cancer.gov/types/myeloproliferative/hp/myelodysplastic-treatment-pdq
- NCI, clinical trial eligibility: https://www.cancer.gov/research/participate/clinical-trials/how-trials-work
- CDC, travelers with chronic illnesses: https://www.cdc.gov/yellow-book/hcp/travelers-with-additional-considerations/travelers-with-chronic-illnesses.html
- CDC, immunocompromised travelers: https://www.cdc.gov/yellow-book/hcp/travelers-with-additional-considerations/immunocompromised-travelers.html
...
- [Twenty Questions About Myelodysplastic Syndrome: Diagnosis, Transfusions, Medicines, Transplant and Care in China](/guides/patient-education-faq/myelodysplastic-syndrome-patient-faq)
