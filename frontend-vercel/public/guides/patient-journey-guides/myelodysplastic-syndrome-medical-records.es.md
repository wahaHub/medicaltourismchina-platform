...
Guarde por separado los informes de aspirado y biopsia, incluidos los identificadores de las muestras, las fechas y todas las páginas. Los dos procedimientos aportan información distinta, como explica la [guía de MedlinePlus sobre pruebas de médula ósea](https://medlineplus.gov/lab-tests/bone-marrow-tests/). Aportar solo un informe puede dejar fuera de la revisión parte de la evaluación original.
...
Si se ha calculado IPSS-M, adjunte los informes utilizados en aquel momento. La [publicación sobre IPSS-M](https://doi.org/10.1056/EVIDoa2200008) describe el uso de información molecular en la evaluación del riesgo. No necesita calcular la puntuación usted mismo. Marque como ausente cualquier resultado genético no analizado o pendiente para que el hematólogo pueda valorar si la información está completa.
...
El tratamiento previo puede determinar si otra opción es adecuada. Por ejemplo, el [anuncio de aprobación de imetelstat de la FDA](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-imetelstat-low-intermediate-1-risk-myelodysplastic-syndromes-transfusion-dependent) describe criterios de elegibilidad relacionados con la respuesta previa a los ESA y la carga transfusional. Esos detalles deben permanecer en los antecedentes. Esta información regulatoria estadounidense no establece la aprobación ni el suministro en China.
...
Si ha comenzado la evaluación para trasplante, añada los informes HLA, el progreso de la búsqueda de donante y las evaluaciones orgánicas completadas. Un trasplante previo requiere un resumen separado que incluya fecha del trasplante, acondicionamiento, fuente celular, quimerismo y vigilancia de la enfermedad, enfermedad de injerto contra huésped e inmunosupresión actual. El [recurso de NMDP sobre decisiones terapéuticas](https://www.nmdp.org/patients/understanding-transplant/treatment-decisions) puede ayudar a plantear preguntas sobre riesgos y beneficios, mientras que el equipo responsable determina el plan.
...
- NCI, búsqueda de atención y obtención de una segunda opinión: https://www.cancer.gov/about-cancer/managing-care/finding-cancer-care
- Clasificación de Consenso Internacional: https://pmc.ncbi.nlm.nih.gov/articles/PMC9479031/
- MedlinePlus, pruebas de médula ósea: https://medlineplus.gov/lab-tests/bone-marrow-tests/
- Bernard y colaboradores, IPSS-M: https://doi.org/10.1056/EVIDoa2200008
- MedlinePlus, detección de anticuerpos contra los glóbulos rojos: https://medlineplus.gov/lab-tests/red-blood-cell-antibody-screen/
- FDA, aprobación de imetelstat en SMD: https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-imetelstat-low-intermediate-1-risk-myelodysplastic-syndromes-transfusion-dependent
- NMDP, decisiones terapéuticas: https://www.nmdp.org/patients/understanding-transplant/treatment-decisions
- NCI, comunicación con el equipo sanitario: https://www.cancer.gov/about-cancer/coping/adjusting-to-cancer/talk-with-doctors
...
- [Veinte preguntas sobre el síndrome mielodisplásico: diagnóstico, transfusiones, medicamentos, trasplante y atención en China](/es/guides/patient-education-faq/myelodysplastic-syndrome-patient-faq)
...
- [Volver a casa después del tratamiento del SMD en China: pruebas de seguimiento, transfusiones, recetas y cuidados del trasplante](/es/guides/patient-journey-guides/myelodysplastic-syndrome-follow-up-after-return-home)
