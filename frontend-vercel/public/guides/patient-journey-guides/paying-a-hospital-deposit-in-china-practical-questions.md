...
- **Title:** Hospital Deposits in China: Match the Payer, Patient Account and Refund Route
- **Category:** Patient Journey Guides
- **Subcategory:** Cross-Border Payment, Receipts and Reconciliation
- **Subtitle:** A hospital can receive the money and still be unable to match it to the right patient. Control the payment instruction, four reference numbers, official receipt and refund destination before funds move.
- **Reviewed by:** Medora Health Editorial Team
- **Updated date:** 2026/08/04
- **Hero image:** `hero-simple.png`
- **Image alt text:** Conceptual international patient discussing an admission form and payment arrangements at a hospital service desk; it is not an actual hospital cashier window, invoice or quoted price.
...
1. hospital legal name and campus;
2. patient's passport name plus medical record or inpatient number;
3. payment purpose and amount in renminbi (RMB);
4. authorised payment channel or beneficiary account;
5. payment deadline and any bed-release consequence;
6. whether partial payment is accepted;
7. contact for payment matching and receipt collection;
8. cancellation and refund route.
...
1. **patient number:** medical record number or inpatient account;
2. **hospital instruction number:** payment notice/order, if issued;
3. **financial transaction number:** card authorisation, wallet order or bank remittance reference;
4. **hospital receipt number:** official receipt or electronic medical billing ticket.
...
1. confirm all clinical departments have posted or withdrawn their charges;
2. compare the itemised statement with performed services and room dates;
3. apply insurer payments, guarantees or package credits correctly;
4. calculate the balance payable or refundable;
5. record the refund amount, route, reference and expected processing window;
6. collect the final receipt/e-ticket and any credit or cancellation document.
...
- **Meta title:** Paying a Hospital Deposit in China | Receipts and Refunds
- **Meta description:** Match the payer, patient account, hospital beneficiary, transaction reference, official receipt and refund route when paying a hospital deposit in China.
- **Primary keyword:** hospital deposit China international patient
- **Pillar keyword:** medical travel to China
- **Vertical keyword:** paying a Chinese hospital from overseas
- **Search intent:** payment preparation / deposit troubleshooting
- **Secondary keywords:** China hospital prepayment; overseas card Chinese hospital; hospital deposit receipt China; hospital refund China; international patient payment

## Sources

1. [National Health Commission and Partner Agencies — Regulation of Prepayments at Public Medical Institutions (2025)](https://www.nhc.gov.cn/caiwusi/c100043/202503/6e557f14642445099064cf61ef1645ca.shtml)
2. [State Council of the People's Republic of China — Payment Guide for Overseas Visitors to China](https://english.www.gov.cn/news/202404/11/content_WS6617c858c6d0868f4e8e5f4d.html)
