# 139 Боль после процедуры: определите функциональную цель и границу резервного обезболивания

## Hero

- **Title:** Боль после процедуры: определите функциональную цель и границу резервного обезболивания
- **Category:** Руководства по пути пациента
- **Subcategory:** Острая боль, безопасность лекарств и функциональное восстановление
- **Subtitle:** Хорошее лечение боли не гонится за нулем на шкале. Оно определяет характер боли, поддерживает дыхание и движение, ограничивает вред лечения и устанавливает, когда обычного плана уже недостаточно.
...
- **Meta title:** Боль после процедуры | Вопросы и проверки безопасности
