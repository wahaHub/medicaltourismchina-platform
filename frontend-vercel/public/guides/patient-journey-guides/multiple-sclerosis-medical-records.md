# Medical Records for an MS Consultation in China: Showing How the Disease Has Changed
...
Pregnancy intentions, breastfeeding, recent infections, vaccination records, liver disease and care from other specialties may affect treatment discussions. The 2026 Association of British Neurologists pregnancy guidance places planning in the context of the specific disease-modifying medicine. Preparing for a pregnancy does not itself mean that every therapy should be stopped. [2026 guidance on MS and pregnancy](https://pubmed.ncbi.nlm.nih.gov/42397849/)
...
- [Follow-Up After Multiple Sclerosis Care in China: Connecting Results to Decisions](/guides/patient-journey-guides/multiple-sclerosis-follow-up-after-return-home)
