# 143 Перелет после операции или лечения: допуск зависит от профиля риска, а не даты

## Hero

- **Title:** Перелет после операции или лечения: допуск зависит от профиля риска, а не даты
- **Category:** Руководства по пути пациента
- **Subcategory:** Готовность к перелету и возвращение домой
- **Subtitle:** Календарь — лишь один фактор. Необходимо оценить замкнутые скопления газа, кислородный резерв, риск тромбов, неустраненные осложнения и способность справиться с днем в аэропорту.
...
- **Meta title:** Когда безопасно лететь после операции? | Проверка по пяти направлениям
