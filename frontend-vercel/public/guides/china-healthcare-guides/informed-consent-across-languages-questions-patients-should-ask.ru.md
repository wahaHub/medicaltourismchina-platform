# 014 Информированное согласие при языковом барьере: вопросы, которые стоит задать пациентам

## Hero

- **Title:** Информированное согласие при языковом барьере: вопросы, которые стоит задать пациентам
