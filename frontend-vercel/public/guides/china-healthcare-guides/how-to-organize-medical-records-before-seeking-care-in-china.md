...
- **Title:** How to Organise Medical Records Before Seeking Care in China
- **Category:** China Healthcare Guides
- **Subcategory:** Medical Records and Case Preparation
- **Subtitle:** Build a review set a clinician can scan quickly, trace back to original evidence and update without losing the treatment timeline.
- **Reviewed by:** Medora Health Editorial Team; specialty-specific medical review required before publication
- **Updated date:** 2026/08/03
- **Hero image:** `hero-reviewed.png`
- **Image alt text:** An international patient presents an organised folder of medical records to a Chinese doctor
...
|---|---|---|---|
| 2025-09-14 | CT chest | 2.1 cm right upper-lobe lesion | `2025-09-14_CT-chest_report.pdf` |
| 2025-09-26 | Biopsy | Adenocarcinoma; addendum pending | `2025-09-26_pathology_prelim.pdf` |
| 2025-10-03 | Pathology addendum | Molecular result issued | `2025-10-03_pathology_addendum.pdf` |
...
Before uploading or carrying a disc, open it. Check that it contains the right patient, date and body part; confirm that the DICOM directory or image folders are present. Do not rename thousands of internal DICOM files. Rename the enclosing folder instead, such as `2026-02-11_MRI-brain_DICOM`.
...
- **Meta title:** Organise Medical Records for Care in China
- **Meta description:** Build a clear clinical summary, timeline, medication list, pathology set and DICOM imaging package for review by a Chinese hospital.
- **Primary keyword:** organise medical records for China hospital
- **Pillar keyword:** healthcare in China for international patients
- **Vertical keyword:** prepare medical records for Chinese doctor
- **Search intent:** informational / case preparation
- **Secondary keywords:** medical record checklist China; DICOM upload Chinese hospital; translate medical records for China

## Sources

1. [US Food and Drug Administration: Create and Keep a Medication List for Your Health](https://www.fda.gov/consumers/consumer-updates/create-and-keep-medication-list-your-health)
2. [DICOM Standard Committee: About DICOM](https://www.dicomstandard.org/about)
3. [National Health Commission: Provisions on the Management of Medical Records in Medical Institutions (2013 Edition)](https://www.nhc.gov.cn/yzygj/c100068/201312/c9955f0471c04450a9f9ab74648fbdd4.shtml)
