# Как читать заключение при лимфоме из клеток мантии: объяснение Cyclin D1, SOX11, Ki-67 и TP53

## Hero

- **Title:** Как читать заключение при лимфоме из клеток мантии: объяснение Cyclin D1, SOX11, Ki-67 и TP53
- **Category:** Информация для пациентов и частые вопросы
- **Subcategory:** Лимфома из клеток мантии
- **Subtitle:** Связанные запросы: положительный cyclin D1; Ki-67 при MCL; мутация TP53 при лимфоме из клеток мантии
