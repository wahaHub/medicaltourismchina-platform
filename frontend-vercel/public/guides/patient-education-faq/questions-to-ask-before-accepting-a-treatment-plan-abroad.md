...
1. arrival and pre-treatment assessment;
2. tests or pathology review still required;
3. decision point when the plan becomes final;
4. treatment dates and named site;
5. expected ward, ICU or outpatient course;
6. discharge criteria;
7. accommodation and daily review after discharge;
8. clearance criteria for the actual return route;
9. remote and home-clinician follow-up.
...
1. [National Institute for Health and Care Excellence — Shared Decision Making Recommendations](https://www.nice.org.uk/guidance/ng197/chapter/Recommendations)
2. [Agency for Healthcare Research and Quality — About Shared Decision Making](https://www.ahrq.gov/sdm/about/index.html)
3. [U.S. Centers for Disease Control and Prevention — Medical Tourism, Yellow Book](https://www.cdc.gov/yellow-book/hcp/health-care-abroad/medical-tourism.html)
4. [American College of Surgeons — Questions to Ask Before Having an Operation](https://www.facs.org/for-patients/surgery-faq/10-questions/)
5. [American College of Surgeons — Statement on Principles](https://www.facs.org/about-acs/statements/statements-on-principles/)
