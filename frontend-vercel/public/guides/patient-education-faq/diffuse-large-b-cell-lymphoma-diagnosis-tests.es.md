# Diagnóstico de LDCBG en China: biopsia, estadificación y preparación
...
- **Title:** Diagnóstico de LDCBG en China: biopsia, estadificación y preparación
- **Subtitle:** Prepare el diagnóstico de linfoma difuso de células B grandes en China: tejido para biopsia, estudios moleculares, PET/TC y evaluación previa al tratamiento.
...
- [S1] [NCI: PDQ sobre tratamiento del linfoma no Hodgkin agresivo de células B](https://www.cancer.gov/types/lymphoma/hp/aggressive-b-cell-lymphoma-treatment-pdq)
...
- [Preguntas frecuentes de pacientes sobre LDCBG: 20 preguntas sobre tratamiento, recaída y atención en China](/es/guides/patient-education-faq/diffuse-large-b-cell-lymphoma-patient-faq)
- [Comprender un informe de LDCBG: anatomía patológica, FISH, IPI y hallazgos PET](/es/guides/patient-education-faq/diffuse-large-b-cell-lymphoma-report-explained)
- [Tipos y riesgo del LDCBG: distinguir la biología de la enfermedad de la aptitud para el tratamiento](/es/guides/patient-education-faq/diffuse-large-b-cell-lymphoma-types-and-risk)

## SEO Metadata

- **Primary keyword:** pruebas diagnósticas de LDCBG

- **Meta title:** Diagnóstico de LDCBG en China: biopsia, estadificación y preparación
- **Meta description:** Prepare el diagnóstico de linfoma difuso de células B grandes en China: tejido para biopsia, estudios moleculares, PET/TC y evaluación previa al tratamiento.
