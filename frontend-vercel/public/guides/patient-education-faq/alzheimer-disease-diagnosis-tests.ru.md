...
- **Title:** Обследования при подозрении на болезнь Альцгеймера: что должна установить клиника памяти
- **Category:** Информация для пациентов и частые вопросы
- **Subcategory:** Болезнь Альцгеймера
- **Subtitle:** Оценка памяти может привести к обсуждению когнитивного тестирования, МРТ, биомаркеров крови, ПЭТ или люмбальной пункции.
