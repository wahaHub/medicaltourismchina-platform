...
Si ya se ha realizado una biopsia, empiece por obtener el informe completo, incluidas las tinciones adicionales, los resultados moleculares y la localización de la muestra. Un especialista receptor puede solicitar la revisión de los portaobjetos existentes antes de recomendar otro procedimiento. Una fotografía de la línea del diagnóstico final omite información que podría evitar pruebas innecesarias. Si no se ha obtenido tejido, un hematólogo puede ayudar a coordinar la elección de la biopsia con un cirujano o un radiólogo intervencionista. [Recomendaciones diagnósticas de NICE](https://www.nice.org.uk/guidance/NG52/chapter/Recommendations)
...
FLIPI utiliza factores clínicos, como edad, estadio, hemoglobina, LDH y áreas ganglionares, para respaldar una conversación sobre pronóstico. No convierte un caso estable y asintomático en una urgencia terapéutica automática. Del mismo modo, la investigación sobre progresión dentro de 24 meses identifica una evolución clínica adversa en grupos después de la terapia; el estudio inicial no puede decir con certeza a una persona que tendrá progresión temprana. [Validación de POD24 en ensayos clínicos](https://pubmed.ncbi.nlm.nih.gov/34614146/)
...
- [Veinte preguntas de pacientes sobre linfoma folicular y atención en China](/es/guides/patient-education-faq/follicular-lymphoma-patient-faq)
- [Leer un informe de linfoma folicular: qué pueden decir la anatomía patológica, la PET y los resultados sanguíneos](/es/guides/patient-education-faq/follicular-lymphoma-report-explained)
