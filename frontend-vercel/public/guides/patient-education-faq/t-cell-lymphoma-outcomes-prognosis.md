...
Age, functional status, LDH, disease extent and marrow findings may contribute to risk tools. PIT was developed retrospectively in a defined PTCL population and is not automatically suitable for every T-cell entity. Historical outcome estimates linked to a score should not ignore changes in treatment when being discussed with a person today. [Gallamini et al.: Prognostic Index for PTCL, 2004 original study](https://pubmed.ncbi.nlm.nih.gov/14645001/)
