...
Estos sistemas estratifican el mieloma activo utilizando distintas combinaciones y agrupaciones de información. R2-ISS separa más el riesgo e incorpora información del cromosoma 1q. Cuando un registro dice estadio III, identifique primero el sistema. La estadificación pronóstica del mieloma no debe interpretarse como si fuera la estadificación metastásica de un tumor sólido no relacionado. [Estudio de desarrollo y validación de R2-ISS](https://pubmed.ncbi.nlm.nih.gov/35605179/)
...
- [Tratamiento del mieloma múltiple: proteger los órganos al planificar el control a largo plazo](/es/guides/treatment-guides/multiple-myeloma-treatment-overview)
...
- [Comprender un informe de mieloma múltiple: proteína, médula, imágenes y ERM](/es/guides/patient-education-faq/multiple-myeloma-report-explained)
- [Comenzar el tratamiento de primera línea del mieloma múltiple](/es/guides/treatment-guides/multiple-myeloma-first-line-treatment)
