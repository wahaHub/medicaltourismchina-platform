# Diagnose des multiplen Myeloms in China: Untersuchungen und Vorbereitung
...
- **Title:** Diagnose des multiplen Myeloms in China: Untersuchungen und Vorbereitung
- **Subtitle:** Untersuchungen bei Myelomverdacht in China verstehen: Protein- und Urintests, Knochenmark, FISH und Bildgebung zur Diagnose und Behandlungsvorbereitung verbinden.
...
Risikomodelle kombinieren mehrere Befunde, statt sich auf ein einzelnes Genergebnis zu stützen. FISH, Laktatdehydrogenase, Albumin und Beta-2-Mikroglobulin können je nach verwendetem Modell zur Beurteilung beitragen. R2-ISS beschreibt Unterschiede zwischen Gruppen neu diagnostizierter Patienten; es ist keine persönliche Lebenszeitberechnung. Fragen Sie, ob ein fehlender Test die heutige Entscheidung beeinflusst oder ergänzt werden kann, während andere notwendige Versorgung weitergeht. [Originalstudie zum R2-ISS](https://pubmed.ncbi.nlm.nih.gov/35605179/)
...
- [Einen Befund zum multiplen Myelom verstehen: Protein, Knochenmark, Bildgebung und MRD](/de/guides/patient-education-faq/multiple-myeloma-report-explained)
- [Typen und Risiken des multiplen Myeloms: die unterschiedlichen Bezeichnungen verstehen](/de/guides/patient-education-faq/multiple-myeloma-types-and-risk)

## SEO Metadata

- **Primary keyword:** diagnostische Untersuchungen multiples Myelom

- **Meta title:** Diagnose des multiplen Myeloms in China: Untersuchungen und Vorbereitung
- **Meta description:** Untersuchungen bei Myelomverdacht in China verstehen: Protein- und Urintests, Knochenmark, FISH und Bildgebung zur Diagnose und Behandlungsvorbereitung verbinden.
