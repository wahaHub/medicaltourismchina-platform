# Benefits, Risks and Alternatives: How to Make Medical Numbers Mean Something

## Hero

- **Title:** Benefits, Risks and Alternatives: How to Make Medical Numbers Mean Something
- **Category:** Patient Education & FAQ
- **Subcategory:** Patient Decision-Making & Caregiver Support
- **Subtitle:** A plain-language guide to absolute risk, comparable options, meaningful outcomes, uncertainty and teach-back across languages.
- **Reviewed by:** Medora Health Editorial Team
- **Updated date:** 2026/08/04
- **Hero image:** `hero-simple.png`
- **Image alt text:** Clinician uses simple benefit, risk and choice symbols while discussing treatment with a patient and companion
...
> For people like me, this option aims to ___, measured by ___, over ___, compared with ___.
...
1. **Chance:** how often it occurs in a relevant group.
2. **Severity:** what actually happens to the patient.
3. **Timing:** during treatment, early recovery or years later.
4. **Reversibility:** temporary, treatable, disabling or permanent.
...
- **SEO title:** Benefits, Risks and Alternatives in Plain Language
- **Meta description:** Understand absolute versus relative risk, comparable options, meaningful outcomes, uncertainty and teach-back before a medical decision.
- **Primary keyword:** benefits risks and alternatives plain language
- **Secondary keywords:** absolute risk medical treatment, informed consent numbers, medical risk communication, treatment option comparison, teach-back consent
- **Suggested URL slug:** `/benefits-risks-alternatives-plain-language`

## Sources

1. [National Institute for Health and Care Excellence — Communicating Risks, Benefits and Consequences](https://www.nice.org.uk/guidance/ng197/chapter/recommendations)
2. [Agency for Healthcare Research and Quality — Use the Teach-Back Method](https://www.ahrq.gov/health-literacy/improve/precautions/tool5.html)
3. [U.S. Centers for Disease Control and Prevention — Numeracy and Health Literacy](https://www.cdc.gov/health-literacy/php/research-summaries/numeracy.html)
4. [Agency for Healthcare Research and Quality — About Shared Decision Making](https://www.ahrq.gov/sdm/about/index.html)
5. [U.S. Centers for Disease Control and Prevention — Plain Language Materials and Resources](https://www.cdc.gov/health-literacy/php/develop-materials/plain-language.html)
6. [The Joint Commission — Informed Consent: More Than Getting a Signature](https://digitalassets.jointcommission.org/api/public/content/42fff32a10ff4f4399ed5d545b9a1994?v=ebd5273e)
