# Обследования при фолликулярной лимфоме: выбор биопсии, определение стадии и безопасная подготовка к лечению

## Hero

- **Title:** Обследования при фолликулярной лимфоме: выбор биопсии, определение стадии и безопасная подготовка к лечению
- **Category:** Обучение пациентов и часто задаваемые вопросы
- **Subcategory:** Фолликулярная лимфома
- **Subtitle:** Увеличенный шейный узел или снимок с описанием нескольких увеличенных лимфоузлов не устанавливают фолликулярную лимфому.
