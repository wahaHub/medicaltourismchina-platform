...
- **Title:** 糖尿病患者赴中国就医：用药、饮食与监测
- **Subtitle:** 糖尿病医疗出行规划：胰岛素保存、跨时区用药、血糖监测、餐食、术前禁食、泵和CGM及急症处理。
...
糖尿病患者赴中国就医时，行程需要配合用药、进餐和监测计划。出发前应与处方团队讨论时区变化、进餐延误、操作前禁食以及备用物资安排。
...
- **Meta title:** 糖尿病患者赴中国就医：用药、饮食与监测
