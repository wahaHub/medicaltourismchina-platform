# Безопасность переливания крови: определите необходимость, подберите компонент и наблюдайте за пациентом

## Hero

- **Title:** Безопасность переливания крови: определите необходимость, подберите компонент и наблюдайте за пациентом
- **Category:** Информация для пациентов и часто задаваемые вопросы
- **Subcategory:** Хирургия и безопасность в больнице
- **Subtitle:** Руководство для пациента об эритроцитах, тромбоцитах и плазме, информированном согласии, определении группы крови и пробах на совместимость, проверках личности у постели, трансфузионных реакциях и способах сбережения крови.
...
- **SEO title:** Безопасность переливания крови: согласие, подбор, реакции и альтернативы
