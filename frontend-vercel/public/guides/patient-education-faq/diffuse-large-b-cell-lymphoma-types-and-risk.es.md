...
- [S4] [FDA: Polatuzumab vedotina con R-CHP para el LDCBG no tratado previamente](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-polatuzumab-vedotin-piiq-previously-untreated-diffuse-large-b-cell-lymphoma-not)
...
- [Cómo entender un informe de LDCBG: anatomía patológica, FISH, IPI y hallazgos de PET](/es/guides/patient-education-faq/diffuse-large-b-cell-lymphoma-report-explained)
- [Elegir el tratamiento de primera línea para el LDCBG y prepararse para el primer ciclo](/es/guides/treatment-guides/diffuse-large-b-cell-lymphoma-first-line-treatment)
