...
Un aspirado y una biopsia con cilindro pueden aportar información sobre la cantidad, el aspecto y la distribución de las células plasmáticas, mientras que la citometría de flujo ayuda a identificar un fenotipo anormal. Estos componentes se complementan. La dilución de un aspirado o una enfermedad de distribución irregular pueden hacer especialmente relevante la información del tejido. El resultado debe integrarse con los estudios de proteínas y las imágenes en lugar de reducirse a un porcentaje. [Información del NCI sobre neoplasias de células plasmáticas](https://www.cancer.gov/types/myeloma/hp/myeloma-treatment-pdq)
...
- [Comprender un informe de mieloma múltiple: proteínas, médula ósea, imágenes y enfermedad residual medible](/es/guides/patient-education-faq/multiple-myeloma-report-explained)
- [Tipos y riesgo del mieloma múltiple: comprender las diferentes denominaciones](/es/guides/patient-education-faq/multiple-myeloma-types-and-risk)
