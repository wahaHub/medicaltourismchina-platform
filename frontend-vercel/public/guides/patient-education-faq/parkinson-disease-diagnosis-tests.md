...
Young onset, a relevant family history, or a particular research opportunity can make genetic counseling especially useful. Patients without those features may also wish to discuss testing, but should understand the expected information. A disease-causing variant, a risk variant, and a variant of uncertain significance have different meanings. Some variants do not result in disease in every carrier. Because one person's findings may affect relatives' choices, explanation before testing matters as much as interpretation afterward. [Expert review of Parkinson's genetic testing](https://pubmed.ncbi.nlm.nih.gov/37365908/)
