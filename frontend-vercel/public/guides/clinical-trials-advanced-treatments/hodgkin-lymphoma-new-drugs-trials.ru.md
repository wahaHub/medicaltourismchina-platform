...
- **Title:** Новые лекарства и клинические исследования при лимфоме Ходжкина: как отличить установленные доказательства от исследовательских подходов
- **Category:** Клинические исследования и передовые методы лечения
- **Subcategory:** Лимфома Ходжкина
- **Subtitle:** Поиск новых методов лечения лимфомы Ходжкина может вывести на один экран одобренное лекарство, поддержанную руководствами комбинацию, раннее клеточное исследование и лабораторный эксперимент.
