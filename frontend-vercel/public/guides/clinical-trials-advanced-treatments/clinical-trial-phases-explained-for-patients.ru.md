# 072 Фазы клинических исследований: объяснение для пациентов

## Hero

- **Title:** Фазы клинических исследований: объяснение для пациентов
- **Category:** Клинические исследования и передовые методы лечения
- **Subcategory:** Основы клинических исследований
- **Subtitle:** Используйте фазу для понимания главного вопроса исследования, затем прочитайте фактический протокол, группы, конечные точки и прежние доказательства, прежде чем оценивать личную применимость.
...
- **Meta title:** Фазы клинических исследований 0–IV: объяснение для пациентов
