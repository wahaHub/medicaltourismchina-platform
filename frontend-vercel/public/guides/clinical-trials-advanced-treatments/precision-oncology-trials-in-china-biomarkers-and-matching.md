...
- **Title:** Precision Oncology Trials in China: Biomarkers and Matching
- **Category:** Clinical Trials & Advanced Treatments
- **Subcategory:** Biomarker-Directed Trials
- **Subtitle:** A molecular finding becomes a credible trial lead only after the sample, assay, exact variant, evidence, disease context and protocol cohort all line up.
- **Reviewed by:** Medora Health Editorial Team
- **Updated date:** 2026/08/03
- **Hero image:** `hero-reviewed.png`
- **Image alt text:** An oncology clinician discusses a biomarker-directed trial match with a patient beside DNA, molecular-target and patient-cohort symbols in China.
...
- **Meta title:** Precision Oncology Trials in China: Biomarker Matching
- **Meta description:** Learn how tissue, liquid biopsy, exact variants, evidence tiers and master-protocol cohorts determine credible biomarker trial matches in China.
- **Primary keyword:** precision oncology trials China
- **Secondary keywords:** biomarker matched clinical trial; cancer NGS China; liquid biopsy trial eligibility; basket trial; molecular tumour board
- **Search intent:** biomarker-directed trial matching / oncology decision support

## Sources

1. [US National Cancer Institute — Biomarker Testing for Cancer Treatment](https://www.cancer.gov/about-cancer/treatment/types/biomarker-testing-cancer-treatment)
2. [AMP, ASCO and CAP — Standards for Interpretation and Reporting of Sequence Variants in Cancer](https://pubmed.ncbi.nlm.nih.gov/27993330/)
3. [US Food and Drug Administration — Companion Diagnostics](https://www.fda.gov/medical-devices/in-vitro-diagnostics/companion-diagnostics)
4. [US National Cancer Institute — Liquid Biopsy and False-Negative Results](https://www.cancer.gov/news-events/cancer-currents-blog/2017/liquid-biopsy-detects-treats-cancer)
5. [European Society for Medical Oncology Working Group — ESCAT Evidence Framework](https://pubmed.ncbi.nlm.nih.gov/30137196/)
