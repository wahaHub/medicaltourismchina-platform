...
1. the site is initiated/activated under the specified protocol and current version;
2. local ethics approval remains valid;
3. the named principal investigator is responsible at this campus;
4. the cohort relevant to the patient is open;
5. the first clinical contact is an authorised study-team member;
6. screening procedures will occur only after the required consent.
...
2. [National Medical Products Administration — Drug Clinical Trial Registration Service Guide](https://zwfw.nmpa.gov.cn/web/taskview/11100000MB0341032Y100207202900001)
3. [NMPA/CDE — Drug Clinical Trial Registration and Information Disclosure Platform](https://www.chinadrugtrials.org.cn/)
4. [NMPA and NHC — Record-Filing Management of Drug Clinical Trial Institutions](https://english.nmpa.gov.cn/2019-11/29/c_448732.htm)
5. [NMPA — Medical Device Clinical Trial Institution Filing Service](https://zwfw.nmpa.gov.cn/web/taskview/11100000MB0341032Y100207202100001)
