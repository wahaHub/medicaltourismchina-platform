...
Manche Patienten benötigen eine Abklärung auf Neuromyelitis-optica-Spektrum-Erkrankung oder MOG-Antikörper-assoziierte Erkrankung. Diese Erkrankungen können sich hinsichtlich der verursachten Symptome mit MS überschneiden, ihre Mechanismen und Behandlungspfade sind aber verschieden. Antikörpertests sollten eine klinische Frage beantworten; ein positiver Befund ersetzt insbesondere bei unpassendem klinischem Kontext keine vollständige Beurteilung. Ändert sich die vorgeschlagene Diagnose, fragen Sie, welcher Befund dies ausgelöst hat und wie sich die Therapieempfehlung dadurch verändert. [NEMOS-Empfehlungen zur Differenzialdiagnose](https://pubmed.ncbi.nlm.nih.gov/37022481/), [Internationale MOGAD-Diagnosekriterien](https://pubmed.ncbi.nlm.nih.gov/36706773/)
...
Verfahren können bei schweren Schüben oder bestimmten Komplikationen erwogen werden. Auch autologe hämatopoetische Stammzelltransplantation kann in sorgfältig ausgewählten MS-Situationen besprochen werden, umfasst aber intensive Behandlung und Immunrekonstitution. Sie entspricht nicht einer allgemeinen Stammzellinfusion, die mit dem Ersatz beschädigten Myelins beworben wird. Patientenauswahl, Zentrumserfahrung und Nachsorge stehen im Mittelpunkt der ECTRIMS- und EBMT-Empfehlungen von 2025. [ECTRIMS- und EBMT-Konsens zur AHSCT](https://pubmed.ncbi.nlm.nih.gov/39814869/)
...
Klären Sie vor Beginn eines neuen Medikaments, wo Bluttests und Bildgebung erfolgen, wer sie prüft und wie mögliche Infektionen oder Schübe gemeldet werden. Die Impfplanung hängt von der konkreten Therapie und dem Immunstatus ab. MS ordnet nicht jeden Patienten derselben Immunsuppressionskategorie zu, und Patienten sollten DMT nicht selbstständig absetzen, um Impfungen zu organisieren. [ECTRIMS- und EAN-Impfkonsens](https://pubmed.ncbi.nlm.nih.gov/37293841/)
...
- [Untersuchungen bei Verdacht auf Multiple Sklerose: Vorbereitung auf MRT, Liquoruntersuchung und fachärztliche Beurteilung](/de/guides/patient-education-faq/multiple-sclerosis-diagnosis-tests)
- [Einen MS-Bericht verstehen: MRT-Läsionen, Liquorergebnisse und Funktionsmessungen](/de/guides/patient-education-faq/multiple-sclerosis-report-explained)
...
- [Die erste MS-Behandlung wählen: aus einer ersten Verordnung einen umsetzbaren Plan machen](/de/guides/treatment-guides/multiple-sclerosis-first-line-treatment)
