...
- Kortikosteroide, krankheitsmodifizierende Therapie (DMT) und Rehabilitation können Bestandteil desselben Plans sein. Sie sind nicht zwangsläufig konkurrierende Pakete. NICE behandelt Schubversorgung, Symptome und koordinierte Betreuung getrennt, weil die Ergebnisse unterschiedlich beurteilt werden müssen. [NICE-Empfehlungen zur MS-Versorgung](https://www.nice.org.uk/guidance/ng220/chapter/Recommendations)
...
OPERA liefert unter den Bedingungen der Studie Evidenz zum Vergleich von Ocrelizumab mit Interferon beta-1a. Die Studie berichtet unterschiedliche klinische und bildgebende Ergebnisse. Einen dieser Endpunkte als Heilungsrate umzuformulieren verändert die Aussage der Studie. [Originalbericht der OPERA-Studie](https://pubmed.ncbi.nlm.nih.gov/28002679/)

ASCLEPIOS verwendete Teriflunomid als Vergleichstherapie. Unterschiede bei Populationen, Vorbehandlung, Krankheitsaktivität und Nachbeobachtung sind bei der Interpretation neben einem anderen Studienprogramm wichtig. Zwei Prozentwerte aus unterschiedlichen Studien lassen sich nicht einfach so in eine Rangfolge bringen, als wären die Medikamente gegeneinander geprüft worden. [Originalbericht der ASCLEPIOS-Studie](https://pubmed.ncbi.nlm.nih.gov/32757523/)
...
Impf- und Infektionsplanung können die Durchführbarkeit von Immuntherapien verändern. Empfehlungen unterscheiden sich je nach Arzneimittel, auch hinsichtlich des Zeitpunkts und der erwarteten Impfantwort. Sie sollten für die tatsächlich zur Wahl stehenden Optionen geprüft werden. [Impfkonsens von ECTRIMS und EAN](https://pubmed.ncbi.nlm.nih.gov/37293841/)
...
- [Die erste MS-Therapie wählen: Aus einer ersten Verordnung einen umsetzbaren Plan machen](/de/guides/treatment-guides/multiple-sclerosis-first-line-treatment)
- [Verfahren bei Multipler Sklerose: Plasmaaustausch, AHSCT und Vorbereitung auf die Behandlung](/de/guides/treatment-guides/multiple-sclerosis-surgery-procedures)
