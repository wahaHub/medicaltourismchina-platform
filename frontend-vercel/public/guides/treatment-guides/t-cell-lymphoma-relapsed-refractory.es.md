# Linfoma de células T en recaída en China: revisión y siguiente línea de atención
...
- **Title:** Linfoma de células T en recaída en China: revisión y siguiente línea de atención
- **Subtitle:** Prepare la revisión de linfoma de células T en recaída en China con confirmación del cambio, antecedentes reales y objetivos para la siguiente línea de tratamiento.
...
Las opciones pueden incluir quimioterapia de rescate, conjugados de anticuerpo y fármaco, terapias epigenéticas u otros mecanismos. Alguien que necesita control rápido y puede tolerar tratamiento intensivo tiene limitaciones diferentes de quien presenta recuperación lenta de los recuentos sanguíneos después de varias líneas. Esquemas como ICE o DHAP que aparecen en el resumen del NCI son posibles vías clínicas, no un menú del que los pacientes puedan prescribirse tratamientos. [PDQ del NCI: tratamiento del linfoma no Hodgkin periférico de células T](https://www.cancer.gov/types/lymphoma/hp/peripheral-t-cell-lymphoma-pdq)
...
- [Cheson y colaboradores: clasificación de Lugano para la evaluación y respuesta del linfoma](https://pmc.ncbi.nlm.nih.gov/articles/PMC4979083/)
- [d’Amore y colaboradores: guía ESMO–EHA para linfomas periféricos de células T y NK, 2025](https://pmc.ncbi.nlm.nih.gov/articles/PMC12059256/)
...
- [PDQ del NCI: tratamiento del linfoma no Hodgkin periférico de células T](https://www.cancer.gov/types/lymphoma/hp/peripheral-t-cell-lymphoma-pdq)
- [Hübel y colaboradores: otros linfomas agresivos B y T, manual de la EBMT 2024](https://www.ncbi.nlm.nih.gov/books/NBK608293/)
- [Comisión Nacional de Salud de China: «Principios orientadores para la aplicación clínica de nuevos fármacos antitumorales (edición de 2025)», publicados el 2026-01-26](https://www.nhc.gov.cn/yzygj/c100067/202601/460c2377aa294b55baacd339b8b19eb8.shtml)
- [Song y colaboradores: JACKPOT8 Parte B, estudio de fase 2 de golidocitinib](https://pubmed.ncbi.nlm.nih.gov/38092009/)
- [Mehta-Shah y colaboradores: resultados finales de fase 2 de PRIMO con duvelisib en linfoma periférico de células T en recaída/refractario, 2026](https://pubmed.ncbi.nlm.nih.gov/42018969/)
- [NCI: cómo funcionan los ensayos clínicos](https://www.cancer.gov/research/participate/clinical-trials/how-trials-work)
- [Grupo de Trabajo de Linfoma de la EBMT: trasplante alogénico para las principales entidades de linfoma de células T, 2026](https://pubmed.ncbi.nlm.nih.gov/41723532/)
...
- [NCI: cuidados paliativos en el cáncer](https://www.cancer.gov/about-cancer/advanced-cancer/care-choices/palliative-care-fact-sheet)
...
- [Veinte preguntas de los pacientes sobre el linfoma de células T: diagnóstico, tratamiento y decisiones diarias](/es/guides/patient-education-faq/t-cell-lymphoma-patient-faq)
- [¿Cuánto puede durar la remisión en el linfoma de células T? Comprender el pronóstico y las cifras de supervivencia](/es/guides/patient-education-faq/t-cell-lymphoma-outcomes-prognosis)
- [Nuevos fármacos y ensayos para el linfoma de células T en 2026: convertir una actualización de investigación en una opción verificable](/es/guides/clinical-trials-advanced-treatments/t-cell-lymphoma-new-drugs-trials)

## SEO Metadata

- **Primary keyword:** tratamiento del linfoma de células T en recaída o refractario

- **Meta title:** Linfoma de células T en recaída en China: revisión y siguiente línea de atención
- **Meta description:** Prepare la revisión de linfoma de células T en recaída en China con confirmación del cambio, antecedentes reales y objetivos para la siguiente línea de tratamiento.
