# Сколько длится реабилитация после инсульта? Связь стационарной, амбулаторной и домашней помощи

## Hero

- **Title:** Сколько длится реабилитация после инсульта? Связь стационарной, амбулаторной и домашней помощи
- **Category:** Руководства по лечению
- **Subcategory:** Реабилитация после ишемического инсульта
- **Subtitle:** Когда семья спрашивает, сколько займет реабилитация, вопрос обычно включает несколько сроков: длительность текущей госпитализации, момент пересмотра лечения и занятия, необходимые после выписки.
