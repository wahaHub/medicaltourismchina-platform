...
- **Title:** Getting a Cancer Second Opinion in China
- **Category:** Treatment Guides
- **Subcategory:** Cancer Care
- **Subtitle:** A useful second opinion tests the diagnosis, staging and treatment logic—not just whether another doctor prefers a different drug.
- **Reviewed by:** Medora Health Editorial Team; oncology review required before publication
- **Updated date:** 2026/08/03
- **Hero image:** `hero-reviewed.png`
- **Image alt text:** An oncologist explains a second-opinion decision pathway to a patient and companion
...
- **Meta title:** Getting a Cancer Second Opinion in China
- **Meta description:** Prepare pathology, imaging and treatment records for a cancer second opinion in China, choose the right reviewer, and compare conflicting recommendations.
- **Primary keyword:** cancer second opinion in China
- **Pillar keyword:** cancer treatment in China
- **Vertical keyword:** getting a cancer second opinion in China
- **Search intent:** high-intent informational / care planning
- **Secondary keywords:** oncology consultation China; pathology review China; international cancer patient China

## Sources

1. [National Cancer Institute: Definition of Second Opinion](https://www.cancer.gov/publications/dictionaries/cancer-terms/def/second-opinion)
2. [National Cancer Institute: Surgical Pathology Reports and Second Opinions](https://www.cancer.gov/about-cancer/diagnosis-staging/diagnosis/pathology-reports-fact-sheet)
