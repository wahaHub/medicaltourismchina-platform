# Контроль побочных эффектов лечения РТПХ: симптомы, мониторинг и непрерывность помощи

## Hero

- **Title:** Контроль побочных эффектов лечения РТПХ: симптомы, мониторинг и непрерывность помощи
- **Category:** Руководства по лечению
- **Subcategory:** Реакция «трансплантат против хозяина»
- **Subtitle:** Во время лечения реакции «трансплантат против хозяина» утомляемость, диарея или отклонение печеночного анализа могут иметь несколько возможных объяснений.
