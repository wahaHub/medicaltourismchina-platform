...
- **Title:** Рецидивирующая или рефрактерная фолликулярная лимфома: подтвердите изменения перед выбором следующей линии
- **Category:** Руководства по лечению
- **Subcategory:** Фолликулярная лимфома
- **Subtitle:** Повторное обнаружение узла после лечения не требует автоматического повторения прежней схемы и не означает, что полезные варианты исчерпаны.
