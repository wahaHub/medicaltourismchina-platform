# Tratamiento de la anemia aplásica: desde la protección inmediata hasta una recuperación medular duradera

## Hero

- **Title:** Tratamiento de la anemia aplásica: desde la protección inmediata hasta una recuperación medular duradera
- **Category:** Guías de tratamiento
- **Subcategory:** Anemia aplásica
- **Subtitle:** Después de un diagnóstico de anemia aplásica, la primera pregunta práctica es si el paciente necesita protección hospitalaria ahora.
...
- [Peffault de Latour y colaboradores: insuficiencia medular adquirida, manual EBMT 2024](https://www.ncbi.nlm.nih.gov/books/NBK608280/)
...
- [Peffault de Latour y colaboradores: eltrombopag añadido a la inmunosupresión en anemia aplásica grave, 2022](https://pubmed.ncbi.nlm.nih.gov/34986284/)
...
- [Schrezenmeier y colaboradores: apoyo transfusional, manual EBMT 2024](https://www.ncbi.nlm.nih.gov/books/NBK608283/)
- [Patel y colaboradores: resultados a largo plazo tras inmunosupresión y eltrombopag](https://pmc.ncbi.nlm.nih.gov/articles/PMC8718619/)
- [Suárez-Lledó y Rovira: controles a corto y largo plazo después del TPH, manual EBMT 2024](https://www.ncbi.nlm.nih.gov/books/NBK608290/)
...
- [Diagnóstico de anemia aplásica: pruebas esenciales e investigaciones dirigidas](/es/guides/patient-education-faq/aplastic-anemia-diagnosis-tests)
- [Cómo entender un informe de anemia aplásica: hipocelularidad, clones de HPN y hallazgos genéticos](/es/guides/patient-education-faq/aplastic-anemia-report-explained)
- [Tipos y riesgo de anemia aplásica: qué significan no grave, grave y muy grave](/es/guides/patient-education-faq/aplastic-anemia-types-and-risk)

## SEO Metadata

- **Primary keyword:** tratamiento de la anemia aplásica
