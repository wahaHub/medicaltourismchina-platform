...
- [Pruebas ante sospecha de esclerosis múltiple: prepararse para RM, análisis del líquido cefalorraquídeo y revisión especializada](/es/guides/patient-education-faq/multiple-sclerosis-diagnosis-tests)
- [Comprender un informe de EM: lesiones en la RM, resultados del líquido cefalorraquídeo y mediciones funcionales](/es/guides/patient-education-faq/multiple-sclerosis-report-explained)
...
- [Elegir el primer tratamiento para la EM: convertir una prescripción inicial en un plan viable](/es/guides/treatment-guides/multiple-sclerosis-first-line-treatment)
