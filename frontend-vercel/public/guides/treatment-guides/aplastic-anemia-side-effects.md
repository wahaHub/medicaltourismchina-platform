...
Cyclosporine can affect renal function, blood pressure, and electrolytes before a patient notices a clear symptom. Scheduled tests and pressure checks therefore remain necessary when counts improve. Concentration sampling also needs its relationship to dosing; a result without this context can be misleading. [MedlinePlus: Cyclosporine](https://medlineplus.gov/druginfo/meds/a601207.html)
...
Jaundice, dark urine, upper-right abdominal discomfort, or substantial new fatigue should prompt assessment. Liver tests remain necessary even when the patient feels well. Whether a result needs interruption or adjustment depends on severity, trend, and the wider clinical picture. [MedlinePlus: Eltrombopag](https://medlineplus.gov/druginfo/meds/a609011.html)
...
Future component selection or preventive arrangements depend on the investigation. Keep the component, start and stop times, symptoms, tests, and treatment. “Blood allergy” loses distinctions that may be important at the next infusion, especially after changing hospitals. [Schrezenmeier et al.: Transfusion Support, EBMT Handbook 2024](https://www.ncbi.nlm.nih.gov/books/NBK608283/)
...
- [New drugs and trials for aplastic anemia: interpreting progress and checking eligibility](/guides/clinical-trials-advanced-treatments/aplastic-anemia-new-drugs-trials)
