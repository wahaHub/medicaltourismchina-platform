...
- **Title:** إجراءات التصلب المتعدد: تبديل البلازما وزرع الخلايا الجذعية المكوّنة للدم ذاتياً والتحضير قبل العلاج
- **Category:** أدلة العلاج
- **Subcategory:** التصلب المتعدد
- **Subtitle:** لا يُعالج التصلب المتعدد عادةً باستئصال آفة معينة جراحياً.
