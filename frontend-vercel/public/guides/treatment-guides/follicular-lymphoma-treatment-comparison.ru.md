# Сравнение методов лечения фолликулярной лимфомы: какие варианты решают одну и ту же задачу?

## Hero

- **Title:** Сравнение методов лечения фолликулярной лимфомы: какие варианты решают одну и ту же задачу?
- **Category:** Руководства по лечению
- **Subcategory:** Фолликулярная лимфома
- **Subtitle:** Прежде чем сравнивать методы лечения фолликулярной лимфомы, определите, предназначены ли они для решения одной и той же клинической задачи.
