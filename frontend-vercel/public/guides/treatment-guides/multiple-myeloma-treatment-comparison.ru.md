...
- **Title:** Сравнение методов лечения множественной миеломы: учитывайте этап и историю резистентности
- **Category:** Руководства по лечению
- **Subcategory:** Множественная миелома
- **Subtitle:** Если две рекомендации по миеломе различаются, вопрос «какая сильнее» может не помочь с выбором.
