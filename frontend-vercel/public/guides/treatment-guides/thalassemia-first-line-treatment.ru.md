# Начало помощи при талассемии в Китае: первый план лечения
...
- **Title:** Начало помощи при талассемии в Китае: первый план лечения
- **Subtitle:** Первый план помощи при талассемии в Китае: уточнение формы, объяснение носительства и выбор поддержки по потребностям пациента после установления диагноза.
...
- **Meta title:** Начало помощи при талассемии в Китае: первый план лечения
- **Meta description:** Первый план помощи при талассемии в Китае: уточнение формы, объяснение носительства и выбор поддержки по потребностям пациента после установления диагноза.
