# Memulai pengobatan lini pertama untuk mieloma multipel

## Hero

- **Title:** Memulai pengobatan lini pertama untuk mieloma multipel
- **Category:** Panduan Pengobatan
- **Subcategory:** Mieloma Multipel
- **Subtitle:** Pengobatan lini pertama adalah strategi sistemik awal untuk mengendalikan mieloma aktif.
...
PERSEUS mendukung jalur yang mengandung daratumumab pada pasien baru terdiagnosis yang memenuhi syarat transplantasi, tetapi perbandingannya melibatkan pengaturan induksi, konsolidasi, dan pemeliharaan. Studi ini tidak menunjukkan bahwa penambahan obat yang sama pada sembarang waktu menghasilkan manfaat identik. Tanyakan bagian jalur uji klinis yang menyerupai rekomendasi Anda dan bukti yang mendukung setiap perbedaan yang direncanakan. [Uji acak PERSEUS](https://pubmed.ncbi.nlm.nih.gov/38084760/)
...
- [Jenis dan risiko mieloma multipel: memahami berbagai istilah](/id/guides/patient-education-faq/multiple-myeloma-types-and-risk)
- [Membandingkan pengobatan mieloma multipel: sesuaikan dengan tahap dan riwayat resistensi](/id/guides/treatment-guides/multiple-myeloma-treatment-comparison)

## SEO Metadata

- **Primary keyword:** pengobatan lini pertama untuk mieloma multipel
