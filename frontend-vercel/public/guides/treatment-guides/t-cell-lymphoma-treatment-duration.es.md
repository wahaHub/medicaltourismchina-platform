# Tratamiento del linfoma de células T en China: ciclos y planificación del viaje
...
- **Title:** Tratamiento del linfoma de células T en China: ciclos y planificación del viaje
- **Subtitle:** Planifique el tratamiento del linfoma de células T en China según subtipo, ciclos, recuperación, controles y posible trasplante antes de fijar fechas de viaje.
...
Una evaluación intermedia examina la respuesta durante un curso de tratamiento, mientras que una evaluación al final ayuda a establecer el resultado global. Las imágenes necesitan compararse con las iniciales e interpretarse junto con los síntomas y la exploración. Las infecciones, la inflamación y los cambios relacionados con el tratamiento pueden influir en los hallazgos de la PET, así que conserve las fechas de tratamientos y enfermedades recientes. Realizar imágenes con mayor frecuencia no conduce automáticamente a una decisión más fiable. [Cheson et al.: clasificación de Lugano para la evaluación y la respuesta del linfoma](https://pmc.ncbi.nlm.nih.gov/articles/PMC4979083/)

Cuando se programe una prueba de imagen, pregunte qué cuestión pretende responder, si el resultado puede modificar el siguiente ciclo y cómo se investigaría una lesión incierta. El consenso PRoLoG describe detalles prácticos para aplicar de forma uniforme la evaluación de Lugano. Mantener las imágenes originales en una misma cronología ayuda a los equipos a comparar exploraciones en vez de basarse en palabras descriptivas aisladas de informes separados. [Iniciativa de consenso PRoLoG: aplicación clínica de la evaluación de Lugano](https://pmc.ncbi.nlm.nih.gov/articles/PMC9841255/)

## Un cambio de fecha es una decisión clínica que debe explicarse

Una infección, una recuperación insuficiente de los recuentos sanguíneos, una inflamación bucal importante o síntomas nerviosos pueden llevar a cambiar el calendario de tratamiento. Mantener el control de la enfermedad debe equilibrarse con evitar daños prevenibles. Pregunte qué causó el retraso, qué volverá a comprobarse y qué hallazgos permitirían reiniciar el tratamiento. Ocultar síntomas para mantener la cita original o tomar dosis orales adicionales para recuperar un total calculado por cuenta propia puede interferir con una atención segura. [NCI: Infección y neutropenia durante el tratamiento del cáncer](https://www.cancer.gov/about-cancer/treatment/side-effects/infection)
...
- [d’Amore et al.: guía ESMO–EHA para los linfomas periféricos de células T y NK, 2025](https://pmc.ncbi.nlm.nih.gov/articles/PMC12059256/)
- [NCI PDQ: Tratamiento del linfoma no Hodgkin infantil](https://www.cancer.gov/types/lymphoma/hp/child-nhl-treatment-pdq)
- [NCI: Quimioterapia para tratar el cáncer](https://www.cancer.gov/about-cancer/treatment/types/chemotherapy)
- [Horwitz et al.: resultados a cinco años de ECHELON-2](https://pmc.ncbi.nlm.nih.gov/articles/PMC9447792/)
...
- [Cheson et al.: clasificación de Lugano para la evaluación y la respuesta del linfoma](https://pmc.ncbi.nlm.nih.gov/articles/PMC4979083/)
- [Iniciativa de consenso PRoLoG: aplicación clínica de la evaluación de Lugano](https://pmc.ncbi.nlm.nih.gov/articles/PMC9841255/)
...
- [Memorial Sloan Kettering: Obtención autóloga de células madre de sangre periférica, 2026](https://www.mskcc.org/cancer-care/patient-education/autologous-peripheral-blood-stem-cell-harvesting)
- [Suárez-Lledó y Rovira: Seguimiento después del trasplante de células hematopoyéticas, Manual de la EBMT 2024](https://www.ncbi.nlm.nih.gov/books/NBK608290/)
- [NCI PDQ: Tratamiento de la micosis fungoide y el síndrome de Sézary](https://www.cancer.gov/types/lymphoma/patient/mycosis-fungoides-treatment-pdq)
- [Wei et al.: estudio de mantenimiento JACKPOT26, Blood Cancer Journal 2026](https://www.nature.com/articles/s41408-026-01452-8)
...
- [Manejo de los efectos secundarios del tratamiento del linfoma de células T: cuándo buscar ayuda y qué registrar en casa](/es/guides/treatment-guides/t-cell-lymphoma-side-effects)
...
- **Primary keyword:** duración del tratamiento del linfoma de células T

- **Meta title:** Tratamiento del linfoma de células T en China: ciclos y planificación del viaje
- **Meta description:** Planifique el tratamiento del linfoma de células T en China según subtipo, ciclos, recuperación, controles y posible trasplante antes de fijar fechas de viaje.
