# Traitement de la SEP en Chine : doses, réévaluation et planification à long terme
...
- **Title:** Traitement de la SEP en Chine : doses, réévaluation et planification à long terme
- **Subtitle:** Distinguez cure d’une poussée, traitement de fond et surveillance de la sclérose en plaques pour discuter des durées et décisions d’arrêt en Chine.
...
L’information chinoise sur l’ocrélizumab décrit un calendrier d’administration initiale puis ultérieure, avec l’évaluation avant traitement, la surveillance de la perfusion et la gestion des risques. L’intervalle entre administrations fait partie du protocole et n’est pas une période que l’on peut prolonger seul. Le prescripteur doit décider si un report est approprié et comment réorganiser le calendrier après un retard. [Information de prescription chinoise de l’ocrélizumab](https://assets.roche.com/f/249469/x/b0c5c7105c/aoruilizhudankangzhusheye_20250325.pdf)
...
La FDA a averti d’aggravations sévères de la SEP après l’arrêt du fingolimod. Si vos réserves diminuent, si votre assurance change ou si un déménagement à l’étranger est prévu, soulevez le problème avant l’interruption. Ne faites pas de pause sans supervision pour tester si la maladie est devenue inactive et n’utilisez pas l’expérience d’un autre médicament pour choisir un calendrier de reprise. [Avertissement de la FDA sur l’arrêt du fingolimod](https://www.fda.gov/media/118217/download)
...
- [Traitement de la sclérose en plaques : construire un plan pour les poussées, la progression et la fonction au quotidien](/fr/guides/treatment-guides/multiple-sclerosis-treatment-overview)
- [Gérer les effets indésirables du traitement de la sclérose en plaques : symptômes, examens et aide en temps utile](/fr/guides/treatment-guides/multiple-sclerosis-side-effects)
...
- [Nouveaux médicaments et essais cliniques pour la sclérose en plaques : interpréter les évolutions de 2026](/fr/guides/clinical-trials-advanced-treatments/multiple-sclerosis-new-drugs-trials)

## SEO Metadata

- **Primary keyword:** durée du traitement de la sclérose en plaques

- **Meta title:** Traitement de la SEP en Chine : doses, réévaluation et planification à long terme
- **Meta description:** Distinguez cure d’une poussée, traitement de fond et surveillance de la sclérose en plaques pour discuter des durées et décisions d’arrêt en Chine.
