# Combien de temps dure le traitement du myélome multiple ? Cycles, entretien et temps passé en Chine
...
L’étude de phase II MASTER a également exploré un traitement adapté à la réponse et son arrêt au sein d’un parcours thérapeutique et d’un contexte de risque génétique particuliers. Son [rapport complet](https://pmc.ncbi.nlm.nih.gov/articles/PMC10836587/) montre pourquoi les règles d’arrêt ne doivent pas simplement être transférées à un autre protocole. Un arrêt proposé doit identifier quel médicament prend fin, quels résultats durables soutiennent la décision, comment la surveillance sera réalisée et ce qui déclencherait une reprise du traitement.
...
- [Gérer les effets indésirables du traitement du myélome multiple : symptômes urgents et poursuite des soins](/fr/guides/treatment-guides/multiple-myeloma-side-effects)
