...
- **Title:** Coronary Angiography in China: What Patients Can Expect
- **Category:** Treatment Guides
- **Subcategory:** Heart & Vascular Care
- **Subtitle:** Understand why an invasive angiogram is proposed, how wrist or groin access works, and what must be agreed before a possible same-session stent.
- **Reviewed by:** Medora Health Editorial Team
- **Updated date:** 2026/08/03
- **Hero image:** `hero-reviewed.png`
- **Image alt text:** Cardiologist explaining coronary arteries and catheter access to a patient
...
1. **Angiography only:** remove the catheter and discuss the result later.
2. **Angiography with authorised same-session PCI:** proceed only if the pre-agreed clinical and anatomical conditions are met.
3. **Emergency rescue treatment:** act if a rare complication or an unstable coronary blockage requires immediate intervention.
...
- **Meta title:** Coronary Angiography in China: Procedure and Safety Guide
- **Meta description:** Prepare for coronary angiography in China: indications, wrist versus groin access, contrast and kidney checks, possible PCI, recovery and records.
- **Primary keyword:** coronary angiography in China
- **Pillar keyword:** heart treatment in China
- **Vertical keyword:** cardiac catheterisation in China
- **Search intent:** procedure preparation / informed consent
- **Secondary keywords:** coronary angiogram China; radial access angiography; cardiac catheterisation; coronary stent consent; angiography recovery

## Sources

1. [American Heart Association — Coronary Angiogram](https://www.heart.org/en/health-topics/heart-attack/diagnosing-a-heart-attack/coronary-angiogram)
2. [American College of Cardiology — 2021 AHA/ACC Chest Pain Guideline Perspectives](https://www.acc.org/latest-in-cardiology/ten-points-to-remember/2021/10/27/14/06/2021-guideline-for-chest-pain-gl_chestpain)
3. [American College of Cardiology — 2021 ACC/AHA/SCAI Coronary Revascularization Guideline: Key Perspectives](https://www.acc.org/latest-in-cardiology/ten-points-to-remember/2021/12/08/21/19/2021-guideline-for-revascularization-gl-revasc)
4. [Society for Cardiovascular Angiography and Interventions — Ad Hoc PCI Consensus Statement](https://scai.org/sites/default/files/2020-12/QITTOTM_2014-11_SCAIConsensus2013.pdf)
