# ¿Cuánto dura el tratamiento del mieloma múltiple? Ciclos, mantenimiento y tiempo en China
...
El estudio de fase II MASTER también exploró el tratamiento adaptado a la respuesta y la suspensión dentro de una vía terapéutica y un contexto de riesgo genético particulares. Su [informe completo](https://pmc.ncbi.nlm.nih.gov/articles/PMC10836587/) muestra por qué las reglas de suspensión no deben trasladarse sin más a otra pauta. Una suspensión propuesta debe identificar qué medicamento termina, qué resultados sostenidos respaldan la decisión, cómo se realizará la vigilancia y qué motivaría reiniciar el tratamiento.
...
El tratamiento biespecífico puede incluir dosis escalonadas, observación inicial y administraciones posteriores repetidas. Los cambios de intervalo y los criterios de suspensión dependen del producto, la combinación y la respuesta. La actualización de 2026 de teclistamab en combinación no permite a los pacientes organizar toda la pauta utilizando instrucciones de monoterapia. La [información de la FDA sobre teclistamab](https://www.fda.gov/drugs/resources-information-approved-drugs/fda-approves-teclistamab-combination-daratumumab-hyaluronidase-fihj-relapsed-or-refractory-multiple) distingue usos que requieren verificación separada.
...
- [Manejo de los efectos adversos del tratamiento del mieloma múltiple: síntomas urgentes y atención continuada](/es/guides/treatment-guides/multiple-myeloma-side-effects)
- [Costes del tratamiento del mieloma múltiple en China: obtener una estimación comparable por etapas](/es/guides/cost-insurance-guides/multiple-myeloma-cost-in-china)
