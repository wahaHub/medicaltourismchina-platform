...
Some patients need evaluation for neuromyelitis optica spectrum disorder or MOG antibody-associated disease. These conditions can overlap with MS in the kinds of symptoms they produce, but their disease mechanisms and treatment pathways are distinct. Antibody testing should answer a clinical question; a positive result, especially in an unsuitable clinical context, is not a substitute for a full assessment. If the proposed diagnosis changes, ask which finding prompted that change and how it affects the treatment recommendation. [NEMOS differential-diagnosis recommendations](https://pubmed.ncbi.nlm.nih.gov/37022481/), [International MOGAD diagnostic criteria](https://pubmed.ncbi.nlm.nih.gov/36706773/)
