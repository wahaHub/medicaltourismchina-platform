...
Una dosis seleccionada para el control duradero de la enfermedad tiene un propósito diferente de un ciclo de dosis muy baja utilizado para aliviar un problema local. Los resultados a largo plazo de FoRT favorecen 24 Gy frente a 4 Gy cuando el objetivo es un control local duradero. Una menor necesidad de alojamiento no puede demostrar que dos pautas sean igual de eficaces. Si el campo de radiación necesario no es adecuado, el equipo debe explicar cómo los síntomas y la carga tumoral conducen a una alternativa. [Estudio aleatorizado de radioterapia FoRT](https://pubmed.ncbi.nlm.nih.gov/33539729/)
...
- [Tipos y riesgo del linfoma folicular: distinguir grado, estadio, FLIPI y progresión temprana](/es/guides/patient-education-faq/follicular-lymphoma-types-and-risk)
- [Comparar los tratamientos del linfoma folicular: ¿qué opciones abordan el mismo problema?](/es/guides/treatment-guides/follicular-lymphoma-treatment-comparison)
