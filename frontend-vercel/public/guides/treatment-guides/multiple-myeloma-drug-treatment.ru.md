...
- **Subtitle:** Назначение при миеломе часто содержит несколько противоопухолевых и профилактических препаратов и стероид, для каждого из которых предусмотрены разные дни лечения.
