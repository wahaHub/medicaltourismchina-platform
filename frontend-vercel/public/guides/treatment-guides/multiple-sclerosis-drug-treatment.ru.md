...
- **Title:** Лекарства при рассеянном склерозе: варианты ПИТРС, мониторинг и плановые переходы
- **Category:** Руководства по лечению
- **Subcategory:** Рассеянный склероз
- **Subtitle:** Списки лекарств от РС различаются из-за различий стран, дат одобрения и показаний по форме заболевания.
